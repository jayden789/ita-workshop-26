"""
Set up Workshop and RegistrationOption instances for ITA 2022.
...
class Command(BaseCommand):
    ...
    help = "Set up the Workshop and RegistrationOption instances for ITA 2022."
    ...
    def setup_dates(self):
        ...
        for day in range(22, 28):
            date_value = datetime.date(2022, 5, day)
    ...
    def setup_workshop(self, dates):
        """Set up the ITA 2022 `Workshop` instance."""
        start_date = dates["2022-05-22"].date_value
        end_date = dates["2022-05-27"].date_value
        update_values = {
            "title": "ITA Workshop 2022",
            "start_date": start_date,
            "end_date": end_date,
            "base_fee_affiliate": Decimal("140.0"),
            "base_fee_full": Decimal("280.0"),
            "base_fee_student": Decimal("140.0"),
            "daily_fee_affiliate": Decimal("60.0"),
            "daily_fee_full": Decimal("60.0"),
            "daily_fee_student": Decimal("40.0"),
        }
        workshop, _ = models.Workshop.objects.update_or_create(
            slug="ita22", defaults=update_values
        )
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            sunday = dates["2022-05-22"].date_value
            monday = dates["2022-05-23"].date_value
            wednesday = dates["2022-05-25"].date_value
            thursday = dates["2022-05-26"].date_value
