"""
Set up Workshop and RegistrationOption instances for ITA 2025.
...
class Command(BaseCommand):
    ...
    help = "Set up the Workshop and RegistrationOption instances for ITA 2025."
    ...
    def setup_dates(self):
        ...
        for day in range(9, 16):
            date_value = datetime.date(2025, 2, day)
    ...
    def setup_workshop(self, dates):
        """Set up the ITA 2025 `Workshop` instance."""
        start_date = dates["2025-02-09"].date_value
        end_date = dates["2025-02-14"].date_value
        update_values = {
