"""
Set up Workshop and RegistrationOption instances for ITA 2020.
...
class Command(BaseCommand):
    ...
    help = "Set up the Workshop and RegistrationOption instances for ITA 2020."
    ...
    def setup_dates(self):
        ...
        for day in range(2, 9):
            date_value = datetime.date(2020, 2, day)
    ...
    def setup_workshop(self, dates):
        """Set up the ITA 2020 `Workshop` instance."""
        start_date = dates["2020-02-03"].date_value
        end_date = dates["2020-02-07"].date_value
        update_values = {
            "title": "ITA Workshop 2020",
            "start_date": start_date,
            "end_date": end_date,
            "base_fee_affiliate": Decimal("125.0"),
            "base_fee_full": Decimal("250.0"),
            "base_fee_student": Decimal("125.0"),
            "daily_fee_affiliate": Decimal("50.0"),
            "daily_fee_full": Decimal("50.0"),
            "daily_fee_student": Decimal("35.0"),
        }
        workshop, _ = models.Workshop.objects.update_or_create(
            slug="ita20", defaults=update_values
        )
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            sunday = dates["2020-02-02"].date_value
            monday = dates["2020-02-03"].date_value
            wednesday = dates["2020-02-05"].date_value
            thursday = dates["2020-02-06"].date_value
            saturday = dates["2020-02-08"].date_value
