...
SUNDAY_RECEPTION_GUESTS = collections.OrderedDict(
    {
        "ita25_sundayReception_selfPlus2": 3,
        "ita25_sundayReception_selfPlus1": 2,
        "ita25_sundayReception_selfOnly": 1,
    }
)

MONDAY_LUNCH_GUESTS = collections.OrderedDict(
    {
        "ita25_mondayReception_attending": 1
    }
)
...
def _write_records():
    ...
    filename = "ita25_name_badge_data_{}.tsv".format(timestamp)
