...
SUNDAY_RECEPTION_GUESTS = collections.OrderedDict(
    {
        "ita24_sundayReception_selfPlus2": 3,
        "ita24_sundayReception_selfPlus1": 2,
        "ita24_sundayReception_selfOnly": 1,
    }
)

MONDAY_LUNCH_GUESTS = collections.OrderedDict(
    {
        "ita24_mondayReception_attending": 1
    }
)
...
def _write_records():
    ...
    filename = "ita24_name_badge_data_{}.tsv".format(timestamp)
