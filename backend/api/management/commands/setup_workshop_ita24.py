...
class Command(BaseCommand):
    ...
    def setup_dates(self):
        ...
        for day in range(18, 25):
            date_value = datetime.date(2024, 2, day)
    ...
    def setup_workshop(self, dates):
        """Set up the ITA 2024 `Workshop` instance."""
        start_date = dates["2024-02-18"].date_value
        end_date = dates["2024-02-23"].date_value
        update_values = {
            "title": "ITA Workshop 2024",
        ...
        workshop, _ = models.Workshop.objects.update_or_create(
            slug="ita24", defaults=update_values
        )
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            sunday = dates["2024-02-18"].date_value
            monday = dates["2024-02-23"].date_value
            wednesday = dates["2024-02-21"].date_value
            thursday = dates["2024-02-22"].date_value
            saturday = dates["2024-02-24"].date_value
            ...
            self.setup_italt(workshop, saturday)
