"""
Set up Workshop and RegistrationOption instances for ITA 2019.
...
class Command(BaseCommand):
    ...
    def setup_dates(self):
        ...
        for day in range(10, 16):
            date_value = datetime.date(2019, 2, day)
    ...
    def setup_workshop(self, dates):
        """Set up the ITA 2019 `Workshop` instance."""
        start_date = dates["2019-02-11"].date_value
        end_date = dates["2019-02-15"].date_value
        update_values = {
            "title": "ITA Workshop 2019",
        ...
        workshop, _ = models.Workshop.objects.update_or_create(
            slug="ita19", defaults=update_values
        )
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            sunday = dates["2019-02-10"].date_value
            monday = dates["2019-02-11"].date_value
            wednesday = dates["2019-02-13"].date_value
            thursday = dates["2019-02-14"].date_value
