...
export default class RegistrationProfile extends React.Component {
  ...
  handleCheckboxInput = event => {
    ...
    this.formError = this.nameError && this.emailError && this.affiliationError && this.titleError;
  }
  ...
  this.state.formError = this.nameError && this.emailError && this.affiliationError && this.titleError;
  }
  ...
  render() {
    ...
    this.state.nameError = this.props.firstName.length < 1 || this.props.lastName.length < 1;
    this.state.affiliationError = !this.props.affiliation || this.props.affiliation == '';
    this.state.emailError = !this.props.email.match(/^([\w.%+-]+)@([\w-]+\.)+([\w]{2,})$/i)
    this.state.formError = this.state.nameError || this.state.emailError || this.state.affiliationError || this.state.titleError;
    ...
    return (
      <Card body>
        <Form>
          ...
          <FormGroup row>
            <Label className="text-danger customProfileWidth ml-3 mt-2">Title* </Label>
            ...
            <FormGroup check inline>
              <Label check className="mr-4">
                <Input
                  ...
                  onChange={e => {this.handleCheckboxInput(e);this.props.enablePresentation()}}
                />
                Dr.
              </Label>
            </FormGroup>
          ...
          <FormGroup row className="mt-0">
            ...
            <Col lg={10}>
              <FormText>
                Please select your affiliation from the drop-down menu. If it is
                not there, please select “add new” to add it.
              </FormText>
            </Col>
          </FormGroup>
          ...
          <FormGroup row>
            <Label for="email" className="text-danger customProfileWidth ml-3 mt-2">
              Email*
            </Label>
            <Col lg={4}>
              <Input
          ...
          {this.state.emailError ? <p className="small text-danger mt-0"> Please add a valid email id</p> : ''}
          <FormGroup row>
          ...
          <FormGroup check row>
            <Col>
              <div className="text-center">
                <Button disabled={this.state.formError}  onClick={this.props.saveChanges}>Save all tabs</Button>
