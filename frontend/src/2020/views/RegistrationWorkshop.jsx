...
function calculateSum(option) {
  if (option === 'Please Select') {
    return 0;
  } else if (option === 'ita20_sundayReception_notAttending') {
    return 0;
  } else if (option === 'ita20_sundayReception_selfOnly') {
    return 1;
  } else if (option === 'ita20_sundayReception_selfPlus1') {
    return 2;
  } else if (option === 'ita20_sundayReception_selfPlus2') {
    return 3;
  }
}
...
function calculateWed(option) {
  return {
    'Please Select': 0,
    ita20_banquetSelf_notAttending: 0,
    ita20_banquetSelf_selfOnly: 1,
    ita20_banquetSelf_selfPlus1: 2,
    ita20_banquetSelf_selfPlus2: 3,
  }[option];
}
function calculateSat(option) {
  return {
    'Please Select': 0,
    ita20_saturdayWorkshop_notAttending: 0,
    ita20_saturdayWorkshop_attending: 1
  }[option];
}
...
/* function calculateValentines(option) {
  return {
    'Please Select': 0,
    ita20_valentinesEvent_notAttending: 0,
    ita20_valentinesEvent_selfOnly: 1,
    ita20_valentinesEvent_selfPlus1: 2,
    ita20_valentinesEvent_selfPlus2: 3,
  }[option];
} */
      ...
      <Card body>
        ...
        <RegistrationInfo />
          ...
          <FormGroup row>
            ...
            <Col lg="auto">
              <FormText color="muted">
                Mexican Quinceañera with buffet dinner, live entertainment, and
          ...
          <FormGroup check row>
            <Col>
              ...
              <form method="post" action="https://test.authorize.net/payment/payment" id="formAuthorizeNetTestPage" name="formAuthorizeNetTestPage">
                ...
                <div>
                  <p style={{ color: 'red', fontSize: '12px' }}>Please save after entering information. Payment will open shortly.</p>
                </div>
                {paymentAllowed ? null : (
                  <UncontrolledTooltip
                    placement="right"
