...
export default class RegistrationTabs extends React.Component {
  ...
  populateOptions(data, urlSlugMap) {
    ...
    if (slugArray.includes('ita20_sundayReception_selfOnly')) {
      this.setState({
        SundayReceptionOption: 'ita20_sundayReception_selfOnly',
      });
    }
    if (slugArray.includes('ita20_sundayReception_notAttending')) {
      this.setState({
        SundayReceptionOption: 'ita20_sundayReception_notAttending',
      });
    }
    if (slugArray.includes('ita20_sundayReception_selfPlus1')) {
      this.setState({
        SundayReceptionOption: 'ita20_sundayReception_selfPlus1',
      });
    }
    if (slugArray.includes('ita20_sundayReception_selfPlus2')) {
      this.setState({
        SundayReceptionOption: 'ita20_sundayReception_selfPlus2',
      });
    }

    if (slugArray.includes('ita20_banquetSelf_notAttending')) {
      this.setState({
        WednesdayBanquetOption: 'ita20_banquetSelf_notAttending',
      });
    }
    if (slugArray.includes('ita20_banquetSelf_selfOnly')) {
      this.setState({ WednesdayBanquetOption: 'ita20_banquetSelf_selfOnly' });
    }
    if (slugArray.includes('ita20_banquetSelf_selfPlus1')) {
      this.setState({ WednesdayBanquetOption: 'ita20_banquetSelf_selfPlus1' });
    }
    if (slugArray.includes('ita20_banquetSelf_selfPlus2')) {
      this.setState({ WednesdayBanquetOption: 'ita20_banquetSelf_selfPlus2' });
    }

    if (slugArray.includes('ita20_valentinesEvent_notAttending')) {
      this.setState({
        ValentinesEventOption: 'ita20_valentinesEvent_notAttending',
      });
    }
    if (slugArray.includes('ita20_valentinesEvent_selfOnly')) {
      this.setState({
        ValentinesEventOption: 'ita20_valentinesEvent_selfOnly',
      });
    }
    if (slugArray.includes('ita20_valentinesEvent_selfPlus1')) {
      this.setState({
        ValentinesEventOption: 'ita20_valentinesEvent_selfPlus1',
      });
    }
    if (slugArray.includes('ita20_valentinesEvent_selfPlus2')) {
      this.setState({
        ValentinesEventOption: 'ita20_valentinesEvent_selfPlus2',
      });
    }

    if (slugArray.includes('ita20_mondayLunch_attending')) {
      this.setState({
        monReceptionOption: 'ita20_mondayLunch_attending',
      });
    }
    if (slugArray.includes('ita20_mondayLunch_notAttending')) {
      this.setState({
        monReceptionOption: 'ita20_mondayLunch_notAttending',
      });
    }

    if (slugArray.includes('ita20_saturdayWorkshop_attending')) {
      this.setState({
        saturdayWorkshopOption: 'ita20_saturdayWorkshop_attending',
      });
    }
    if (slugArray.includes('ita20_saturdayWorkshop_notAttending')) {
      this.setState({
        saturdayWorkshopOption: 'ita20_saturdayWorkshop_notAttending',
      });
    }
  }
  ...
  getEffectiveFees = effectiveFeeType => {
    ...
    return {
      ...
      sunReceptionPrice: optionFees.get('ita20_sundayReception_selfOnly'),
      wedBanquetPrice: optionFees.get('ita20_banquetSelf_selfOnly'),
      valentinesEventPrice: optionFees.get('ita20_valentinesEvent_selfOnly'),
      satWorkshopPrice: optionFees.get('ita20_saturdaySelf_attending'),
    };
  };
