...
export default class Login2020 extends React.Component {
  state = {
    email: '',
    password: '',
    modal: false,
  ...
  render = () => {
    ...
    return (
      <div>
        ...
        <Jumbotron fluid>
          <h2 className="text-center mb-3">ITA Workshop 2020</h2>
          ...
          {this.state.email !== '' ? (
            <ModalBody>
              <p>
                ...
                {this.state.email} (assuming a user with the email you entered exists).
