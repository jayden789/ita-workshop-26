...
const mondayTalks = [
  {
    ...
    title:'Integrated Sensing and Communications: A Communication Theory Perspective',
  ...
  },
  {
    ...
    title:'Examples of Information-Theoretic Models of Circuits in Wireless Communication Systems',
...
const tuesdayTalks = [
  ...
  },
  {
    ...
    abstract:'Some forays into mixing information theory, statistical signal processing, and communications with decidedly science applications will be shared.  A key challenge is the modeling and abstraction of these systems to enable the use of the tools typical in the afore-mentioned disciplines.  Another hurdle to overcome is in the validation of any developed theory or algorithm.  Both of these efforts are often stymied by a limited number of realizations of experimental data. Some recent work gives hope that ITA-like theorists can make meaningful contributions to the analysis and understanding of some of these science problems. In particular, we will talk about molecular communication, bacterial interaction and quantum chemistry.'
