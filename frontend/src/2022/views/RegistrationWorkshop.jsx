...
function calculateSum(option) {
  if (option === 'Please Select') {
    return 0;
  } else if (option === 'ita22_sundayReception_notAttending') {
    return 0;
  } else if (option === 'ita22_sundayReception_selfOnly') {
    return 1;
  } else if (option === 'ita22_sundayReception_selfPlus1') {
    return 2;
  } else if (option === 'ita22_sundayReception_selfPlus2') {
    return 3;
  }
}
...
function calculateWed(option) {
  return {
    'Please Select': 0,
    ita22_banquetSelf_notAttending: 0,
    ita22_banquetSelf_selfOnly: 1,
    ita22_banquetSelf_selfPlus1: 2,
    ita22_banquetSelf_selfPlus2: 3,
  }[option];
}
function calculateSat(option) {
  return {
    'Please Select': 0,
    ita22_saturdayWorkshop_notAttending: 0,
    ita22_saturdayWorkshop_attending: 1
  }[option];
}
