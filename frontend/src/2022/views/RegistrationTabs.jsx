...
export default class RegistrationTabs extends React.Component {
  ...
  loadPayment(data) {
    ...
    return api(data['url'], 'GET').then(registration => {
      if (registration.has_approved_payment) {
        ...
        api(registration.initiate_payment_url, 'POST',{
  ...
  populateOptions(data, urlSlugMap) {
    ...
    if (slugArray.includes('ita22_sundayReception_selfOnly')) {
      this.setState({
        SundayReceptionOption: 'ita22_sundayReception_selfOnly',
      });
    }
    if (slugArray.includes('ita22_sundayReception_notAttending')) {
      this.setState({
        SundayReceptionOption: 'ita22_sundayReception_notAttending',
      });
    }
    if (slugArray.includes('ita22_sundayReception_selfPlus1')) {
      this.setState({
        SundayReceptionOption: 'ita22_sundayReception_selfPlus1',
      });
    }
    if (slugArray.includes('ita22_sundayReception_selfPlus2')) {
      this.setState({
        SundayReceptionOption: 'ita22_sundayReception_selfPlus2',
      });
    }

    if (slugArray.includes('ita22_banquetSelf_notAttending')) {
      this.setState({
        WednesdayBanquetOption: 'ita22_banquetSelf_notAttending',
      });
    }
    if (slugArray.includes('ita22_banquetSelf_selfOnly')) {
      this.setState({ WednesdayBanquetOption: 'ita22_banquetSelf_selfOnly' });
    }
    if (slugArray.includes('ita22_banquetSelf_selfPlus1')) {
      this.setState({ WednesdayBanquetOption: 'ita22_banquetSelf_selfPlus1' });
    }
    if (slugArray.includes('ita22_banquetSelf_selfPlus2')) {
      this.setState({ WednesdayBanquetOption: 'ita22_banquetSelf_selfPlus2' });
    }

    if (slugArray.includes('ita22_valentinesEvent_notAttending')) {
      this.setState({
        ValentinesEventOption: 'ita22_valentinesEvent_notAttending',
      });
    }
    if (slugArray.includes('ita22_valentinesEvent_selfOnly')) {
      this.setState({
        ValentinesEventOption: 'ita22_valentinesEvent_selfOnly',
      });
    }
    if (slugArray.includes('ita22_valentinesEvent_selfPlus1')) {
      this.setState({
        ValentinesEventOption: 'ita22_valentinesEvent_selfPlus1',
      });
    }
    if (slugArray.includes('ita22_valentinesEvent_selfPlus2')) {
      this.setState({
        ValentinesEventOption: 'ita22_valentinesEvent_selfPlus2',
      });
    }

    if (slugArray.includes('ita22_mondayLunch_attending')) {
      this.setState({
        monReceptionOption: 'ita22_mondayLunch_attending',
      });
    }
    if (slugArray.includes('ita22_mondayLunch_notAttending')) {
      this.setState({
        monReceptionOption: 'ita22_mondayLunch_notAttending',
      });
    }

    if (slugArray.includes('ita22_saturdayWorkshop_attending')) {
      this.setState({
        saturdayWorkshopOption: 'ita22_saturdayWorkshop_attending',
      });
    }
    if (slugArray.includes('ita22_saturdayWorkshop_notAttending')) {
      this.setState({
        saturdayWorkshopOption: 'ita22_saturdayWorkshop_notAttending',
      });
    }
  }
  ...
  getEffectiveFees = effectiveFeeType => {
    ...
    return {
      ...
      sunReceptionPrice: optionFees.get('ita22_sundayReception_selfOnly'),
      wedBanquetPrice: optionFees.get('ita22_banquetSelf_selfOnly'),
      valentinesEventPrice: optionFees.get('ita22_valentinesEvent_selfOnly'),
      satWorkshopPrice: optionFees.get('ita22_saturdaySelf_attending'),
    };
  };
  ...
  render() {
    ...
    if (paymentRequired && this.state.paid) {
      paymentAlert = (
        <Alert color="success">
          Thank you for your registration and payment to ITA 2020. If you need
        ...
        <Container>
          <div>
            <Nav tabs>
              ...
              {this.state.poster ? posterNavItem : null}
              {this.state.plenary ? plenaryNavItem : null}
              {this.state.graduationPresentation ? graduationPresentationNavItem : null}
              {this.state.graduationTalk ? graduationTalkNavItem : null}
              {adminNavItem}
            </Nav>
            <TabContent activeTab={this.state.activeTab}>
              ...
              {this.state.poster ? posterTabPane : null}
              {this.state.plenary ? plenaryTabPane : null}
              {this.state.graduationPresentation ? graduationPresentationTabPane : null}
              {this.state.graduationTalk ? graduationTalkTabPane : null}
              {adminTabPane}
            </TabContent>
          </div>
        </Container>
