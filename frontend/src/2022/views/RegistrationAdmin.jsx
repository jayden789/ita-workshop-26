          ...
          <FormGroup check inline>
            <Label check>
              <Input
                ...
                checked={this.props.presentingDefault === true}
          ...
          <FormGroup check inline>
            <Label check>
              <Input
                ...
                value="false"
                name="presentingDefault"
                checked={this.props.presentingDefault === false}
                onChange={e => this.props.handleBinaryOptionChange(e)}
              />
              No
            </Label>
          ...
          <FormGroup check inline>
            <Label check>
              <Input
                ...
                value="true"
                name="poster"
                checked={this.props.poster === true}
          ...
          <FormGroup check inline>
            <Label check>
              <Input
                ...
                checked={this.props.presentingThisYear === true}
                onChange={e => this.props.handleCheckboxChange(e)}
              />
              Regular
            </Label>
          ...
          <FormGroup check inline>
            <Label check>
              <Input
                ...
                value="false"
                name="graduationDay"
                checked={this.props.graduationDay === true}
                onChange={e => this.props.handleCheckboxChange(e)}
              />
              Graduation Day
            </Label>
          ...
          <FormGroup check inline hidden={!this.props.graduationDay}>
            <Label check>
              <Input
                ...
                value="false"
                name="graduationTalk"
                checked={this.props.graduationTalk === true}
                onChange={e => this.props.handleCheckboxChange(e)}
              />
              Talk
            </Label>
          ...
          <FormGroup check inline hidden={!this.props.graduationDay}>
            <Label check>
              <Input
                ...
                checked={this.props.graduationPresentation === true}
                onChange={e => this.props.handleCheckboxChange(e)}
              />
              Presentation
            </Label>
