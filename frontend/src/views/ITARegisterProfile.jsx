...
import styles from './ITARegisterProfile.module.css';

export default class ITARegisterProfile extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Card body>
        <Form>
          ...
          <FormGroup row>
            <Label className="customProfileWidth ml-3 mt-2">Title </Label>
