...
import { scheduleData } from './schedule-118';
...
const rowTimeValues = [
  ...
  [
    ...
    // 3 talks at 13:40
    null,
    ...talksTimeSequence(timeToDate(13, 40), 3),
    // 3 talks at 15:00
    null,
...
export default class SchedulePage extends React.Component {
  ...
  render() {
    ...
    //let daysTabs = days.map((day, index) => {
    //  if (!this.isEmpty(this.state.formattedList)) {
    //    let title = this.state.formattedList[day]['title'];
    //    return (
    //      <NavItem key={index}>
    //        <NavLink
    ...
    // let dayContents = days.map((day, index) => {
    //   if (!this.isEmpty(this.state.formattedList)) {
