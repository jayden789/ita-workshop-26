...
const FROM_RAW_SUNDAY_RECEPTION = {
  ita19_sundayReception_notAttending: 'NOT_ATTENDING',
  ita19_sundayReception_selfOnly: 'SELF_ONLY',
  ita19_sundayReception_selfPlus1: 'SELF_PLUS_1',
  ita19_sundayReception_selfPlus2: 'SELF_PLUS_2',
};
const TO_RAW_SUNDAY_RECEPTION = invertObject(FROM_RAW_SUNDAY_RECEPTION);

const FROM_RAW_BANQUET_SELF = {
  ita19_banquetSelf_notAttending: 'NOT_ATTENDING',
  ita19_banquetSelf_selfOnly: 'SELF_ONLY',
  ita19_banquetSelf_selfPlus1: 'SELF_PLUS_1',
  ita19_banquetSelf_selfPlus2: 'SELF_PLUS_2',
};
const TO_RAW_BANQUET_SELF = invertObject(FROM_RAW_BANQUET_SELF);

const FROM_RAW_VALENTINES_EVENT = {
  ita19_valentinesEvent_notAttending: 'NOT_ATTENDING',
  ita19_valentinesEvent_selfOnly: 'SELF_ONLY',
  ita19_valentinesEvent_selfPlus1: 'SELF_PLUS_1',
  ita19_valentinesEvent_selfPlus2: 'SELF_PLUS_2',
};
const TO_RAW_VALENTINES_EVENT = invertObject(FROM_RAW_VALENTINES_EVENT);

const FROM_RAW_MONDAY_LUNCH = {
  ita19_mondayLunch_notAttending: 'NOT_ATTENDING',
  ita19_mondayLunch_attending: 'ATTENDING',
};
...
const talkFromRaw = raw => {
  const { url, registration: registrationUrl, title, abstract, comment } = raw;
  return { url, registrationUrl, title, abstract, comment };
};
