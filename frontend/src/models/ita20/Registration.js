...
const FROM_RAW_SUNDAY_RECEPTION = {
  ita20_sundayReception_notAttending: 'NOT_ATTENDING',
  ita20_sundayReception_selfOnly: 'SELF_ONLY',
  ita20_sundayReception_selfPlus1: 'SELF_PLUS_1',
  ita20_sundayReception_selfPlus2: 'SELF_PLUS_2',
};
const TO_RAW_SUNDAY_RECEPTION = invertObject(FROM_RAW_SUNDAY_RECEPTION);

const FROM_RAW_BANQUET_SELF = {
  ita20_banquetSelf_notAttending: 'NOT_ATTENDING',
  ita20_banquetSelf_selfOnly: 'SELF_ONLY',
  ita20_banquetSelf_selfPlus1: 'SELF_PLUS_1',
  ita20_banquetSelf_selfPlus2: 'SELF_PLUS_2',
};
const TO_RAW_BANQUET_SELF = invertObject(FROM_RAW_BANQUET_SELF);

const FROM_RAW_VALENTINES_EVENT = {
  ita20_valentinesEvent_notAttending: 'NOT_ATTENDING',
  ita20_valentinesEvent_selfOnly: 'SELF_ONLY',
  ita20_valentinesEvent_selfPlus1: 'SELF_PLUS_1',
  ita20_valentinesEvent_selfPlus2: 'SELF_PLUS_2',
};
const TO_RAW_VALENTINES_EVENT = invertObject(FROM_RAW_VALENTINES_EVENT);

const FROM_RAW_MONDAY_LUNCH = {
  ita20_mondayLunch_notAttending: 'NOT_ATTENDING',
  ita20_mondayLunch_attending: 'ATTENDING',
};
